...
int base64encode(const void* text, unsigned int tsize, unsigned char *md, int mode) {
...
int base64decode(const void* text, unsigned int tsize, unsigned char *md, int mode) {
  if (text == NULL || tsize == 0 || md == NULL)
    return 0;
